...
$lang['mod_non_user_comments_desc']			= "(Pubvana Comment System only) Do you want to moderate non-users and non-logged in users?";
$lang['mod_user_comments_label']			= "Moderate User Comments";
$lang['mod_user_comments_desc']				= "(Pubvana Comment System only) Do you want to moderate logged in users?";
...
$lang['nav_hdr']							= "Navigation";
$lang['index_nav_desc']						= "Drag and Drop items to reorder the links shown on the front navigation of your site. You may nest items into another to create a dropdown menu, simply click and drag the new subitem onto and slightly to the right of the new parent item. <b>Note:</b> The new parent item becomes unusable as a page/post link.";
...
$lang['themes_subheader']					= 'Below is a list of currently installed themes.  To find more themes and installation instructions, visit us at the <a href="https://pubvana.org/addons" target="_blank">Pubvana Addons Website</a>.';
