...
class Widget_Pubvana_archives
{
	...
	/*
		...
		/* 
		 Name of your theme. 
		*/
		public $name = 'Pubvana Archives';

		/*
		  The description of your theme.  (200 chars max)
		 */
		public $description = 'Add Archived (Older) posts to your website.';
		...
		public $options = [
			'numarchives'	=>
						[
							...
							'help_text'		=> 'Choose the maximum number of months to display publicly.',
