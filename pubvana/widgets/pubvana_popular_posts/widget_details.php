...
class Widget_Pubvana_popular_posts
{
	...
	/*
		...
		/* 
		 Name of your theme. 
		*/
		public $name = 'Popular Posts';

		/*
		  The description of your theme.  (200 chars max)
		 */
		public $description = 'Show the most popular posts of your blog. Admin -> Posts';
		...
		public $options = [
			'numposts'	=>
						[
							...
							'help_text'		=> 'Choose the maximum number of posts to display publicly.',
