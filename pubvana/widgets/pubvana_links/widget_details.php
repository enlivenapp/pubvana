...
class Widget_Pubvana_links
{
	...
	/*
		...
		/* 
		 Name of your theme. 
		*/
		public $name = 'Pubvana Links';

		/*
		  The description of your theme.  (200 chars max)
		 */
		public $description = 'Add Links to your website. Admin -> Links';
		...
		public $options = [
			'numlinks'	=>
						[
							...
							'help_text'		=> 'Choose the maximum number of links to display publicly.',
