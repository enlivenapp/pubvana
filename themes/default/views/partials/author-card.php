...
<div class="card border-0 bg-light rounded-3 p-4 my-5 d-flex flex-row align-items-start">
    ...
    <div>
        <div class="d-flex align-items-center mb-1">
            <h6 class="fw-bold mb-0 me-2"><?= esc($display_name) ?></h6>
            <?php if ($website): ?>
                <a href="<?= esc($website) ?>" class="text-muted small me-2" target="_blank" rel="noopener">
                    <i class="fas fa-globe"></i>
                </a>
            <?php endif; ?>
            <?php if ($twitter): ?>
                <a href="https://twitter.com/<?= esc($twitter) ?>" class="text-info small me-2" target="_blank" rel="noopener">
                    <i class="fab fa-twitter"></i>
                </a>
            <?php endif; ?>
            <?php if ($facebook): ?>
                <a href="<?= esc(strpos($facebook, 'http') === 0 ? $facebook : 'https://facebook.com/' . $facebook) ?>"
                   class="text-primary small me-2" target="_blank" rel="noopener">
