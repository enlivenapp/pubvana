            ...
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <div class="mb-0">
                        ...
                        <textarea name="notes" id="notes" class="form-control" rows="4" placeholder="Why this redirect exists"></textarea>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <label class="form-check">
                            <input type="checkbox" name="enabled" value="1" class="form-check-input" checked>
                            <span class="form-check-label">Enabled</span>
                        </label>
                    </div>

                    <button type="submit" class="btn btn-primary w-100">Create Redirect</button>
                </div>
            </div>
        </div>
    </div>
